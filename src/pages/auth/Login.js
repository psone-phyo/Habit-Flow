  ...
  return (
    <div className="flex h-screen">
      <div className="w-1/2 flex-col justify-center p-8 items-center gap-0.5 inline-flex">
          ...
          <div class="rounded justify-start items-center gap-2 inline-flex -translate-y-20 translate-x-1/5">
            <p className="text-center text-[#272727] text-lg font-medium font-['Poppins'] underline leading-normal">
              <Link to="/" className="">Back to Home</Link>
            </p>
          </div>

          <div className="text-center"><span class="text-black text-xl font-medium font-['Poppins'] leading-normal">Welcome Back From </span><span class="text-black text-xl font-extrabold font-['Poppins'] leading-normal">HabitFlow</span><span class="text-black text-2xl font-medium font-['Poppins'] leading-normal">!</span></div>
          <div data-svg-wrapper class="relative">
            <svg width="320" height="2" viewBox="0 0 394 2" fill="none" xmlns="http://www.w3.org/2000/svg" transform="translate(32,0)">
          ...
          <div class="h-[18px] justify-start items-center gap-2 inline-flex ">
            <div class="text-[#777777] text-xs font-medium font-['Poppins'] leading-[18px]">Forgot password?</div>
          </div>
          ...
          <p className="mt-4">
            Don't have an account yet? <Link to="/signup" className="text-orange-500 hover:underline">Sign Up</Link>
          </p>
      ...
      <div className="w-1/2 bg-black flex flex-col items-center py-8 relative">
        ...
        <div className="flex-grow -translate-y-10 flex items-center justify-center">
          <img src={Office} alt="Illustration" className="w-1/2 md:w-2/3 lg:w-3/4 xl:w-4/5 h-auto mx-auto"/>
        </div>
